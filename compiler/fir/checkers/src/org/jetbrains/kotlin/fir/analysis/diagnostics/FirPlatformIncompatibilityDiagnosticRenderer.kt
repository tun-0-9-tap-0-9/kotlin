...
) : ContextIndependentParameterRenderer<Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>> {
    override fun render(
        obj: Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>,
    ): String {
...
class FirIncompatibleExpectedActualClassScopesRenderer(
    private val mode: MultiplatformDiagnosticRenderingMode
) : ContextIndependentParameterRenderer<List<Pair<AbstractFirBasedSymbol<*>, Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>>>> {
    override fun render(
        obj: List<Pair<AbstractFirBasedSymbol<*>, Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>>>
    ): String {
        if (obj.isEmpty()) return ""
...
open class MultiplatformDiagnosticRenderingMode {
    ...
    open fun renderSymbol(sb: StringBuilder, symbol: AbstractFirBasedSymbol<*>, indent: String) {
        sb.append(indent)
...
private fun StringBuilder.renderIncompatibilityInformation(
    map: Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>,
    indent: String,
...
private fun StringBuilder.renderIncompatibleClassScopes(
    unfulfilled: List<Pair<AbstractFirBasedSymbol<*>, Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>>>,
    indent: String,
    mode: MultiplatformDiagnosticRenderingMode
) {
